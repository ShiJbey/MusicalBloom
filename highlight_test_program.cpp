...
HighlightTestProgram::HighlightTestProgram() {
	...
	highlighted = glGetUniformLocation(program, "highlighted");
}

Load< HighlightTestProgram > highlight_test_program(LoadTagInit, [](){
	return new HighlightTestProgram();
});
